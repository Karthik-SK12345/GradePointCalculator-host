...
function addInput(divName, counter) {
    for (i = 1; i <= counter; i++) {
        ...
        <div class='col-50'> <label class="label success" style="min-width:100%;color: #042893;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: uppercase;"><i class="fa fa-check-circle"
            style="width:max-content;  color: black;font-size: larger;text-transform:uppercase;"> </i>  COURSE NO. - ${i}</label>
        </div>
    </div>
<div class='row' title="Enter The Respective Code Of The Subject."><div class='col-75' title="Enter The Respective Code Of The Subject.">     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;" title="Enter The Respective Code Of The Subject."> <span 
style="width:max-content;  color: black;font-size: larger;"> </span> Course Code : </label>
  </div><div class='col-25' title="Enter The Respective Code Of The Subject."> <input type="text" title="Enter The Respective Code Of The Subject." evaluation_tokens" maxlength="12" placeholder="COURSE CODE" id='${courseid}' >  </div>  </div>
  <div class='row' title="Enter The Total Course Credits Registered."><div class='col-75'  title="Enter The Total Course Credits Registered.">     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"  title="Enter The Total Course Credits Registered."><span 
  style="width:max-content;  color: black;font-size: larger;"> </span> Total Credits Registered : </label>
  </div><div class='col-25' title="Enter The Total Course Credits Registered."> 
    <select id="${cid}" style="text-align: center; text-align-last: center;" class="evaluation_tokens" title="Enter The Total Course Credits Registered.">
  ...
  <div class='row' title="Enter The Total Marks Secured."><div class='col-75'title="Enter The Total Marks Secured.">     <label title="Enter The Total Marks Secured." class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"><span 
  style="width:max-content;  color: black;font-size: larger;"> </span> Marks Obtained : </label>
  </div><div class='col-25' title="Enter The Total Marks Secured."> <input type="number" class=" evaluation_tokens ev_tok_mk_obt" max="100" title="Enter The Total Marks Secured." onkeyup="if (this.value[this.value.length - 1] == '.') this.value = this.value.substr(0, this.value.length - 1); if (parseFloat(this.value) > 100) this.value = '100';" placeholder="MARKS " id='${sid}' >  </div>  </div>
  <div class='row' title="Total Marks Of the Course."><div class='col-75' title="Total Marks Of the Course.">     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;" title="Total Marks Of the Course."><span 
  style="width:max-content;  color: black;font-size: larger;"> </span> Total Marks : </label>
  </div><div class='col-25'> <input type="number" class=" evaluation_tokens" value="100" readonly id='${tid}' title="Total Marks Of the Course." >  </div>  </div>
  
  <div class='row' title="If You Passed The Subject Then Enter The Year." ><div class='col-75' title="If You Passed The Subject Then Enter The Year." >     <label title="If You Passed The Subject Then Enter The Year."  class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"><span 
  style="width:max-content;  color: black;font-size: larger;"> </span> Year Of Passing : </label>
  </div><div class='col-25' title="If You Passed The Subject Then Enter The Year." >            <input  type="number" class="yearpicker evaluation_tokens year_of_passing_class" value="" title="If You Passed The Subject Then Enter The Year."  id="${yopid}" placeholder="YEAR OF PASSING" readonly>
  </div><br>`;
...
function addInput_cgpa(divName_cgpa, counter_cgpa) {
    ...
    </div><div class='row'  title="Enter The Total Course Credits Registered"  ><div class='col-75'  title="Enter The Total Course Credits Registered"  >     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;" title="Enter The Total Course Credits Registered"><span 
    style="width:max-content;  color: black;font-size: larger;"> </span> Total Credits Registered
       : </label>
  </div><div class='col-25'> <input type="number" maxlength="2" class=" evaluation_tokens" title="Enter The Total Course Credits Registered"  max="100" onkeyup="if (this.value[this.value.length - 1] == '.') this.value = this.value.substr(0, this.value.length - 1); if (parseFloat(this.value) > 100) this.value = '100';" placeholder="CREDITS" id='${cid_cgpa}' >  </div></div>
      <div class='row' title="Enter The Respective Semester SGPA"><div class='col-75' title="Enter The Respective Semester SGPA"> <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;" title="Enter The Respective Semester SGPA"><span 
      style="width:max-content;  color: black;font-size: larger;"> </span> SGPA Secured 
       : </label></div><div class='col-25'>  <input type="number" max="10" onkeyup="if (this.value[this.value.length - 1] == '.') this.value = this.value.substr(0, this.value.length - 1); if (parseFloat(this.value) > 10) this.value = '10';" placeholder="SGPA" id='${sid_cgpa}' title="Enter The Respective Semester SGPA"></div> </div>
     `;
