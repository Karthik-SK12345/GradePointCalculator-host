...
function addInput(divName, counter) {
    ...
    </div><div class='row'   title="Enter The Total Course Credits Registered" ><div class='col-75'   title="Enter The Total Course Credits Registered" >     <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"   title="Enter The Total Course Credits Registered" >Total Credits Registered : </label>
</div><div class='col-25'   title="Enter The Total Course Credits Registered" > <input   title="Enter The Total Course Credits Registered"  type="number" maxlength="2" class=" evaluation_tokens"  max="100" onkeyup="if (this.value[this.value.length - 1] == '.') this.value = this.value.substr(0, this.value.length - 1); if (parseFloat(this.value) > 100) this.value = '100';" placeholder="CREDITS" id='${cid}' >  </div> </div>
    <div class='row'  title="Enter The Respective Semester SGPA"><div class='col-75'  title="Enter The Respective Semester SGPA"> <label class="label success" style="min-width:100%;color: #0088cc;text-align: center;font-weight: bolder;padding: 0.5rem;text-transform: capitalize;"  title="Enter The Respective Semester SGPA"> SGPA Secured : </label></div><div class='col-25'>  <input type="number" max="10" onkeyup="if (this.value[this.value.length - 1] == '.') this.value = this.value.substr(0, this.value.length - 1); if (parseFloat(this.value) > 10) this.value = '10';" placeholder="SGPA" id='${sid}' title="Enter The Respective Semester SGPA" ></div> </div>
    <hr style="
    border: 0;
